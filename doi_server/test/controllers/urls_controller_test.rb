...
class UrlsControllerTest < ActionController::TestCase
  ...
  test "should create url" do
    assert_difference('Url.count') do
      post :create, url: { datetime_added: @url.datetime_added, doi_id: @url.doi_id, url: @url.url }
    end
  ...
  test "should update url" do
    patch :update, id: @url, url: { datetime_added: @url.datetime_added, doi_id: @url.doi_id, url: @url.url }
    assert_redirected_to url_path(assigns(:url))
  end
