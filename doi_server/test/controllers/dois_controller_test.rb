...
class DoisControllerTest < ActionController::TestCase
  ...
  test "should create doi" do
    assert_difference('Doi.count') do
      post :create, doi: { description: @doi.description, label: @doi.label, user_id: @doi.user_id }
    end
  ...
  test "should update doi" do
    patch :update, id: @doi, doi: { description: @doi.description, label: @doi.label, user_id: @doi.user_id }
    assert_redirected_to doi_path(assigns(:doi))
  end
